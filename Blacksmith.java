...
public class Blacksmith extends Entity {
    ...
    {
    		ProducingBlacksmith producingblacksmith = Factory.createProducingBlacksmith(super.getPosition(),(int)(11500+Math.random()*500), imageStore.getImageList(Factory.getSmithKey())); 
